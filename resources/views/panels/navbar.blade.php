<div class="navbar @if(($configData['isNavbarFixed'])=== true){{'navbar-fixed'}} @endif">
  <nav
    ...
    <div class="nav-wrapper">
      <div class="header-search-wrapper hide-on-med-and-down center">
        <a href="{{ route('peserta.main') }}" class="center" style="display: inline-flex;height: 56px;width: auto;align-items: center;justify-content: center;">
          <img class="hide-on-med-and-down center" width="32" src="{{asset('images/logo/logolkmmdftundip2020HD.png')}}" alt="materialize logo" />
          <span class="logo-text hide-on-med-and-down white-text center" style="font-size: 32px;font-style: bold;">&nbsp;&nbsp;LKMM Dasar Fakultas Teknik 2020</span>
        </a>
        ...
        <li>
          <a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);"
            ...
            <span class="avatar-status avatar-online">
              <img src="{{asset('images/logo/user.png')}}" alt="avatar"><i></i>
            </span>
          </a>
        </li>
        <!-- <li>
