...
return [
    'custom' => [
        ...
        'templateTitle' => 'LKMMD FT', //template Title can be changes default('Materialize)
        'defaultLanguage'=>'en', //set your default language Options: en(default),pt,fr,de
        'largeScreenLogo' => 'images/logo/logoundip.png', //we used saparete log image for large screen and small
        'smallScreenLogo' => 'images/logo/logoundip.png', // pass the image path here e.g:'images/logo/materialize-logo-color.png' note:(Vertical-menu-nav-dark and horizontal-menu template used a single logo in both small and large screen)
